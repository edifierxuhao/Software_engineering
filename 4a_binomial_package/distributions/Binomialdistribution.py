...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        return math.factorial(self.n) *  (self.p ** k) * (1 - self.p) ** (self.n - k) /(math.factorial(k) * math.factorial(self.n - k))
    ...
    def plot_bar_pdf(self):
        ...
        plt.plot(x,y)
        plt.title(f'Binomial Distribution for {self.n} trials with {self.p} probability')
        plt.ylabel('Density')
    ...
    def __add__(self, other):
        ...
        result.stedv = result.calculate_stdev()
